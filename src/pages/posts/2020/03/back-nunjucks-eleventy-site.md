...
However, it didn't take me long to realize that I simply don't know enough JavaScript to implement a *full* switchover. Mr. Lillie and Mr. deHaan had tried to help me with the issues I encountered[^Notably, I couldn't successfully translate the Nunjucks template for my <a href="/posts">posts list pages</a> into a properly <a href="https://11ty.dev/docs/pagination">paginated</a> "feed" (so to speak) using .11ty.js templating. I also couldn't figure out how to make a pure-vanilla-JavaScript version of Max Böck's <a href="https://mxb.dev/blog/using-webmentions-on-static-sites/">superb webmentions-handling Nunjucks code</a>, which I'd shamelessly copied for my own purposes; as a result, I temporarily reverted to using <a href="https://talkyard.io">Talkyard</a> for commenting---which I **still** recommend for general commenting purposes, mind you---because it was easy to insert the necessary Talkyard-provided code into the appropriate .11ty.js template. Incidentally, I removed webmentions (and old pre-webmentions comments) a few days later, so that issue is now moot.] but, in the end, I still was left with multiple key templates in .njk. It wasn't so terrible, but, well, the intent had been to switch, completely. And I couldn't.
